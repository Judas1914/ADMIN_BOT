...
button4 = types.InlineKeyboardButton(text="FanPay.net", callback_data="mr.FanPay")
button5 = types.InlineKeyboardButton(text="Другое/Another", callback_data="mr.Another")
sell.add(button1, button2, button3, button4, button5)
